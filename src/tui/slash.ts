...
export const SLASH_SUBCOMMANDS: SlashSubcommandSpec[] = [
  ...
  { command: "loop", name: "run", value: "/loop run", description: "Start a default Deliver loop" },
  { command: "loop", name: "run deliver", value: "/loop run deliver", description: "Close an end-to-end objective with verification" },
  { command: "loop", name: "run discover", value: "/loop run discover", description: "Explore, experiment, and learn with evidence" },
  { command: "loop", name: "run replay", value: "/loop run replay", description: "Repeat one visible prompt for fixed attempts" },
